        ...
        <DialogHeader>
          <DialogTitle
            className={cn(
              ...
              "after:content-[''] after:duration-700 after:animate-in after:fade-in after:zoom-in after:mt-3 after:block after:rounded-full after:w-36 after:h-1 after:bg-primary-dark after:mx-auto"
            )}
          >
            Quên mật khẩu
          </DialogTitle>
